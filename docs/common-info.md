...
30 сентября 2025 года будет отключен доступ с использованием торговых токенов и прекращен доступ с использованием просмотровых токенов старой (текущей) версии API.

Прикладываем руководство по миграции на новую версию: https://github.com/FinamWeb/finam-trade-api/blob/main/MIGRATION_GUIDE.md
