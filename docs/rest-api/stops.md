...
`marketPrice` - значение `true` означает выставить рыночную заявку, иначе условную заявку с ценой `price`.
...
`marketPrice` - значение `true` означает выставить рыночную заявку, иначе условную заявку.
